...
namespace CHARK.ScriptableScenes.Editor.Utilities
{
    ...
    /// Editor scripts.
    /// </summary>
    public static class ScriptableSceneEditorUtilities
    {
        ...
        /// </returns>
        public static IEnumerable<ScriptableSceneCollection> GetScriptableSceneCollections()
        {
        ...
        public static void Play(this ScriptableSceneCollection collection)
        {
        ...
        internal static void Load(this ScriptableSceneCollection collection)
        {
            ...
            var sceneController = Object.FindFirstObjectByType<ScriptableSceneController>();
            if (sceneController)
            {
        ...
        internal static void Open(this ScriptableSceneCollection collection)
        {
            ...
            {
                Debug.LogWarning($"Collection {collection.Name} does not contain any scenes");
                return;
            }
        ...
        private static void OnPlayModeStateChanged(PlayModeStateChange state)
        {
            switch (state)
            {
                ...
                {
                    if (ScriptableSceneUtilities.TryGetSelectedCollection(out _) == false)
                    {
                        if (ScriptableSceneUtilities.TryGetOpenCollection(out var openCollection))
                        {
                            var scriptableScenes = openCollection.Scenes;
                            var scriptableScene = scriptableScenes.FirstOrDefault();
                            ...
                            ScriptableSceneUtilities.SetSelectedCollection(openCollection);
                        }
                    }
