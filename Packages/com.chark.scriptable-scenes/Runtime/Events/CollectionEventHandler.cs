...
namespace CHARK.ScriptableScenes.Events
{
    ...
    internal sealed class CollectionEventHandler : ICollectionEventHandler
    {
        ...
        internal void RaiseShowTransitionEntered(CollectionTransitionEventArgs args)
        {
            try
            {
                onShowTransitionEntered.Invoke();
                OnShowTransitionEntered?.Invoke(args);
            }
            catch (Exception exception)
            {
                Debug.LogError(exception);
        ...
        internal void RaiseShowTransitionExited(CollectionTransitionEventArgs args)
        {
            try
            {
                onShowTransitionExited.Invoke();
                OnShowTransitionExited?.Invoke(args);
            }
            catch (Exception exception)
            {
                Debug.LogError(exception);
        ...
        internal void RaiseHideTransitionEntered(CollectionTransitionEventArgs args)
        {
            try
            {
                onHideTransitionEntered.Invoke();
                OnHideTransitionEntered?.Invoke(args);
            }
            catch (Exception exception)
            {
                Debug.LogError(exception);
        ...
        internal void RaiseHideTransitionExited(CollectionTransitionEventArgs args)
        {
            try
            {
                onHideTransitionExited.Invoke();
                OnHideTransitionExited?.Invoke(args);
            }
            catch (Exception exception)
            {
                Debug.LogError(exception);
