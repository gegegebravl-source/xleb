namespace CHARK.ScriptableScenes.Events
{
    ...
    /// <summary>
    /// Event used in <see cref="CollectionTransitionEvent"/>.
    /// </summary>
    public readonly struct CollectionTransitionEventArgs
    {
        /// <summary>
        /// Is this the first scene load?
        /// </summary>
        public bool IsFirstLoad { get; }

        internal CollectionTransitionEventArgs(bool isFirstLoad)
        {
